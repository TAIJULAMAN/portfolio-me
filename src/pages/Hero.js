  ...
  <div className="hero" id="home">
    <div className="hero-overlay">
      <div className="description">
        <h2 className="title">Hello,I Am Shah Aman</h2>
        <h3 className="tagline">
          Breaking keyboards and pushing pixels since 2022
        </h3>
        ...
        <div className="hero-btns">
          <button className="hire-me">
            <a
              href="https://drive.google.com/file/d/1RIQlxcFspH89xvugEeEyvgSG_ABMX3rI/view?usp=drive_linkhttps://docs.google.com/document/d/13BeAor0uYgCOgcUctDcuDB3wipaGkIUk2Pd4TlUFn1g"
              target="_blank"
              rel="noreferrer"
            >
              GET MY CV
